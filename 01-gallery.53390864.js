...
const lis = createGallery((0, _galleryItems.galleryItems));
refs.gallery.insertAdjacentHTML("beforeend", lis);
refs.gallery.addEventListener("click", galleryView);
const lightbox = new (0, _simplelightboxDefault.default)(".gallery__item", {
    captionsData: "alt",
    captionDelay: 250
});

},{"./gallery-items":"9C7dK","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.css":"dAm0f","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9C7dK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"dAm0f":[function() {},{}]},["b4hXe","6XVkV"], "6XVkV", "parcelRequire2afd")
